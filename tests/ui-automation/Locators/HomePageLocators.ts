...
export const MAXPRICE_INPUT = 'input#max-input';   
export const SALEITEMS_CHECKBOX = 'text=Sale items';
export const SEARCH_BUTTON = 'button.search-price-range-dropdown--search[type="submit"]';
